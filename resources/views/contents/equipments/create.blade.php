...
<section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        {{ Form::open(array('url' => 'equipments/create-new', 'class' => 'form-horizontal')) }}
              ...
              <tbody>
                <tr>
                  ...
                  <td width="250" style="border: 1px solid #d2d6de !important;">
                    ...
                    <select class="form-control select2" name="iditems[]" id="iditems_1" required>
                    ...
                    <select class="form-control select2" name="idfunlocdetails[]" id="idfunlocdetails_1" required>
